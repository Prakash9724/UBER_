  ...
  return (
    <div className='h-screen relative overflow-hidden'>
            ...
            <div className='h-screen w-screen'>
                ...
                <img src="https://preview.redd.it/nearby-drivers-overlay-just-dropped-in-my-market-but-v0-3l3w0gu80n4d1.jpg?width=1080&crop=smart&auto=webp&s=464060bc7486e5131fd337d8cfb2fb7551347f2a" alt="" />
                {/* <LiveTracking /> */}
            </div>
      ...
      <div ref={vehiclePanelRef} className="fixed w-full z-10 bottom-0 bg-white px-3 py-8 translate-y-full">
        <h3 className="text-2xl font-semibold mb-5">Choose a Vehicle</h3>
            ...
            <div className="flex w-full items-center mb-2 justify-between p-3 border-2 active:border-black rounded-lg">
              ...
              <div className="w-1/2 ">
                <h4 className="font-medium text-base">Uber Go <span><i class="ri-user-4-line"></i>4</span></h4>
            ...
            <div className="flex w-full items-center mb-2 justify-between p-3 border-2 active:border-black rounded-lg">
              ...
              <div className="w-1/2 ">
                <h4 className="font-medium text-base">Uber Moto <span><i class="ri-user-4-line"></i>2</span></h4>
